       ...
       <section className="py-20 px-4 relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 flex justify-center">
              <div className="relative">
                <img src="/IMG-20250613-WA0071.jpg" alt="About Trendymates Award" className="max-w-full h-auto rounded-2xl shadow-2xl shadow-red-500/20 border border-white/10 hover:scale-105 transition-transform duration-500" />
              </div>
            </div>
          </div>
        </div>
      </section>
            {/* Table Ticket Section */}
      <section className="py-20 px-4 relative">
...
<img src="/IMG-20250613-WA0072.jpg" alt="Nomination Categories" className="max-w-full h-auto rounded-2xl shadow-2xl shadow-amber-500/20 border border-white/10 hover:scale-105 transition-transform duration-500" />
            </div>
